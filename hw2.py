...
def redraw(matrix: ndarray, part: vpy.compound, origin: vpy.vector, part_number):
    ...
    rot = matrix[0:3]
    rot = rot[:, [0, 1, 2]]
    part.pos = vpy.vector(part_1.pos.x + matrix[0][3], part_1.pos.y + matrix[1][3], A_1 + matrix[2][3])
...
if __name__ == "__main__":
    ...
    rod2_4: vpy.cylinder = vpy.cylinder(pos=vpy.vector(motor_2.pos.x + 3, motor_2.pos.y + 1.5, motor_2.pos.z),
                                        radius=0.2,
                                        axis=vpy.vector(3, 0, 0))
    rod3_1: vpy.cylinder = vpy.cylinder(pos=vpy.vector(motor_2.pos.x + 6, -motor_2.pos.y, motor_2.pos.z), radius=0.2,
                                        axis=vpy.vector(3, 0, 0))
    rod3_2: vpy.cylinder = vpy.cylinder(pos=vpy.vector(motor_2.pos.x + 6, motor_2.pos.y, motor_2.pos.z), radius=0.2,
                                        axis=vpy.vector(3, 0, 0))
    rod3_3: vpy.cylinder = vpy.cylinder(pos=vpy.vector(motor_2.pos.x + 6 + 3, motor_2.pos.y, motor_2.pos.z), radius=0.2,
                                        axis=vpy.vector(0, 3, 0))
    rod3_4: vpy.cylinder = vpy.cylinder(pos=vpy.vector(motor_2.pos.x + 6 + 3, motor_2.pos.y + 1.5, motor_2.pos.z),
                                        radius=0.2,
                                        axis=vpy.vector(3, 0, 0))
    motor_3: vpy.cylinder = vpy.cylinder(pos=vpy.vector(motor_2.pos.x + 6, -1.5, 0), radius=0.3, axis=vpy.vector(0, 3, 0))
